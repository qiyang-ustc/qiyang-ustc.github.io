...
### 2023
1. **Qi Yang**†, Xing-Yu Zhang, Hai-Jun Liao, Hong-Hao Tu, Lei Wang (2023). [Projected d-wave superconducting state: A fermionic projected entangled pair state study](https://journals.aps.org/prb/abstract/10.1103/PhysRevB.107.125128). *Physical Review B*.
